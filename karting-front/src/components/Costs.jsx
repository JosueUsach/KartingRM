	...
	<div>
		...
		{pricingPlans.map((plan, index) => (
			...
			<ul style={styles.features}>
				...
				<li 
					key={i} 
					style={i === plan.features.length - 1 ? 
		...
		<p style={styles.perPerson}>Se aplica un descuento si hay una cantidad suficiente de personas</p>
		<table style={styles.table}>
			...
			{discountData.map((row, index) => (
				...
				>
				<td style={{...styles.tableCell, fontWeight: 'bold'}}>{row.category}</td>
								<td style={{...styles.tableCell, color: '#d03434', fontWeight: 'bold'}}>
									{row.discount}
								</td>
				</tr>
			))}
		...
		<div style={styles.tableContainer}>
				...
				<p style={styles.perPerson}>Se aplica un descuento según la frecuencia de visitas (Aplicado a cada cliente individualmente)</p>
				<table style={styles.table}>
					<thead>
						<tr>
